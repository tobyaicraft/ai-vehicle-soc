...
class SensorMonitorApp:
    ...
    def _draw_car(self, left_dist, right_dist, us_dist):
        ...
        us_len = max(15, min(140, us_dist * 1.0))
        if us_dist < 20:
        ...
        for i in range(3):
            ...
            c.create_line(cx - 15 - alpha_offset // 2, front_y - alpha_offset,
                          cx + 15 + alpha_offset // 2, front_y - alpha_offset,
                          fill=us_color, width=1, dash=(4, 4))

        c.create_rectangle(cx - 18, front_y - 5, cx + 18, front_y + 2,
